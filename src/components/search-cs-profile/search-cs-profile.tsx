...
interface SearchCSProfileProps {}


const SearchCSProfile: FC<SearchCSProfileProps> = () => {
    return (
    <Row>
       <div className="search-main-wrap">
	<div className="container">
		<div className="back-btn">
			<Link to='/search-cs'><img src={ArrowLeft} alt="<"></img><span>Return to Search Result</span></Link>
		</div>
		<div className="user-info-main">
				...
				<div className="row">
					...
					<div className="col-md-9">
						<div className="user-info">
							<h2>Kate Miller</h2>
							<p className="lead-txt">Registered Nurse</p>
								...
								<div className="row">
									...
									<div className="col-sm-6">
										<div className="user-icons">
											<img src={require("../../asset/search/profile/blue-icon.png")} alt="blue-icon 1"></img>
											<img src={require("../../asset/search/profile/blue-icon.png")} alt="blue-icon 2"></img>
										</div>
									</div>
								</div>	
							</div>
			...
			<div className="caring-nurse">
				<h2>Motivated, caring nurse practitioner</h2>
				<p>Im a registred nurse in the Philippines and have experiencing caring clients in different walks of life. im patience, compassionate with keen and attention to details. I have experienced in O.R theaters and Anosthesia Field apart being a direct caregiver.</p>
			</div>
			<div className="skill-requirement">
				...
				<div className="row">
					<div className="col-sm-6">
						...
						<p>Cancer, Dementia</p>
						<p className="dark-txt">VACCINATED</p>
						<p>Yes</p>
					</div>
					<div className="col-sm-6">
...
export default SearchCSProfile;