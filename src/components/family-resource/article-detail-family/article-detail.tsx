       ...
       <Row className='article-detail-content'>
           <Col className='header-article col-12'>
               <div className='path-detail content-articles'>
                   <Link to='/familyresource' className='link-family-back'>Family Resources </Link> {'>'} {article.name}
               </div>
           </Col>
           ...
           <Col className='col-12'>
               <div className='content-details-last'>
                   <div className='text-details-last'>
                       {article.lastInfo}
                       SOURCE <Link to='/familyresource' className='source-link'>{article.source}</Link>
                   </div>
               </div>
           </Col>
           <Col className='col-12'>
